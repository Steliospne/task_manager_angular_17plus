...
describe('TaskService', () => {
  ...
  let localStorageSpy: jest.SpiedFunction<typeof Storage.prototype.getItem>;
  ...
  it('should initialize with sample data if localStorage is empty', async () => {
  ...
  it('should toggle task completion', async () => {
    ...
    const updatedTask = await firstValueFrom(
      service.toggleTaskCompletion(addedTask.id)
    );
